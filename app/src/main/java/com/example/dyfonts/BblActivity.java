...
public class BblActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contrastsbbl);
    ...
    public void bgTest(View view) {
        Global.bblTime = 30 - (int) timeLeftMs / 1000;
        Intent intent = new Intent(BblActivity.this, BgActivity.class);
