...
public class serifActivity extends timesActivity {
    ...
    public void sansTest(View view) {
        Global.serifTime = 30 - (int) timeLeftMs / 1000;
        Intent intent = new Intent(serifActivity.this, timesActivity.class);
